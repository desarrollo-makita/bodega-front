...
@Component({
  selector: 'app-editar-repuestos-dialog',
  templateUrl: './editar-repuestos-dialog.component.html',
  styleUrls: ['./editar-repuestos-dialog.component.scss']
})
export class EditarRepuestosDialogComponent implements OnInit {
  garantia: any;
 ...
 constructor(
     public dialogRef: MatDialogRef<EditarRepuestosDialogComponent>,
    ...
    ngOnInit(): void {
      console.log("data en el modal ssssss: " ,  this.garantia);
      
      let docEntry =  this.garantia.DocEntryAsociado;
    ...
    guardar(): void {
      ...
      if (this.formularioRepuestos.valid) {
        ...
        this.garantiasServices.editarPedidosIntranet(requestPayload).subscribe({
          next: (res) => {
    ...
    private transformData(payload: any): any {
      ...
      data: {
        ...
        docEntry : payload.DocEntryAsociado,
        docNum : payload.DocNumasociado,

...
export class UserService {
  ...
  private updatetUser = "http://localhost:3024/api/editar-usuarios";
  private getUserNameUrl = "http://localhost:3024/api/get-nombre-usuario";
  private deleteUserUrl = "http://localhost:3024/api/delete-usuario";
  private claveActualUrl = "http://localhost:3024/api/valida-clave-actual";
  private recuperarClaveUrl = "http://localhost:3024/api/recuperar-password";
  private replaceClaveUrl = "http://localhost:3024/api/replace-password-id";
